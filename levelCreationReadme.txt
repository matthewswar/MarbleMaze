Controls:
Left Click and Drag: Rotate the level to tilt the marble in the desired direction.
Space Bar: Reset the marble back to the original starting point.
...
Recognized color codes:
	...
	Any unrecognized color will create holes in the level.
